...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Typing.slow("\n[JIGSAW]: Las reglas son sencillas " + name
                + ", tu victoria depende de tus decisiones. ¿Continuar? (y/n)\n", 40);
        String option;
        ...
        while (lives > 0 && keys < 3) {
            ...
            while (true) {
                ...
                if (userOption.equals("piedra") || userOption.equals("papel")
            ...
            } else if ((userOption.equals("piedra") && jigsawOption.equals("tijera"))
        ...
        if (lives == 0) {
            ...
            Typing.slow("\n[JIGSAW]: Felicidades, " + name
                    + ". Has demostrado que valoras tu vida... por ahora.\n", 50);
        }
        sc.close();
